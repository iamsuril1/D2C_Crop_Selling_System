...
const Contact = () => {
  ...
  const inputClass = (field) =>
    `w-full bg-[#F7FAF7] border-2 rounded-xl px-4 py-3 text-sm text-[#1D1D1D] placeholder-gray-400 outline-none transition-all duration-200 ${
      focused === field
  ...
  return (
    <div className="min-h-screen font-[Poppins] bg-[#F4F6F3] flex items-center justify-center px-4 py-16">
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="mb-8 text-center">
          <span className="inline-block text-xs font-semibold tracking-[0.2em] uppercase text-[#1E9C17] mb-3">
            MeroBari Support
          </span>
          <h1 className="font-[Montserrat] text-3xl sm:text-4xl font-bold text-[#1D1D1D] leading-tight">
            How can we<br />
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-green-900/5 border border-gray-100 overflow-hidden">
          ...
          {/* Footer strip */}
          <div className="bg-[#F7FAF7] border-t border-gray-100 px-8 py-4 flex items-center justify-between">
