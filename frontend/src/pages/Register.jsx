  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 font-[Poppins]">
      ...
      <div className="hidden md:block relative">
        ...
        <div className="relative z-10 flex flex-col justify-center h-full px-16 text-white space-y-8">
          ...
          <p className="text-base text-gray-200 leading-relaxed max-w-2xl">
            Become part of a next-generation agricultural marketplace.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center px-6 py-16 bg-gradient-to-b from-[#FDF8E3] to-[#E6F4EA]">
        {step === 1 ? (
          <form onSubmit={handleSendOtp}
            className="w-full max-w-lg bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-10 space-y-6 border border-green-100">
            <h2 className="font-[Montserrat] text-3xl font-bold text-center text-[#1E9C17]">Create Account</h2>
            ...
            <p className="text-center text-sm text-gray-700">
              ...
              <span className="text-[#1E9C17] cursor-pointer font-medium hover:underline" onClick={() => navigate("/login")}>
                Login
              </span>
            </p>
          </form>
          ...
          <form onSubmit={handleVerifyAndRegister}
            className="w-full max-w-md bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-10 space-y-6 border border-green-100">
