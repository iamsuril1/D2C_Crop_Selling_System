...
const About = () => {
  ...
  return (
    <div className="w-full font-[Poppins] text-[#1D1D1D] overflow-x-hidden">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-24">
          ...
          >
            ...
            <p
              className="mt-8 max-w-xl text-[#D0D0D0] text-lg leading-relaxed"
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to="/register"
                className="bg-[#1E9C17] text-white px-7 py-3.5 rounded-full font-bold text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
              >
                Join MeroBari
              </Link>
              <Link
                to="/contact"
                className="border border-white/30 text-white px-7 py-3.5 rounded-full font-semibold text-sm hover:bg-white/10 transition"
              >
                Contact Us
              </Link>
            </div>
      ...
      <section ref={missionRef} className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative bg-[#0D1F0D] rounded-3xl p-10 overflow-hidden">
                {/* decorative circles */}
                ...
                <div className="relative">
                  <div className="text-[#1E9C17] text-6xl font-serif leading-none mb-4">"</div>
      ...
      {/* ══ STATS ═════════════════════════════════════════════════════════ */}
      <section ref={statsRef} className="py-20 bg-[#F5F7F0]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div
                key={i}
                className={`bg-white rounded-2xl border-2 ${s.border} p-7 text-center
              ...
              >
                <p className={`font-[Montserrat] font-black text-5xl ${s.color}`}>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <div
                key={i}
                className={`group rounded-3xl p-7 border border-gray-100
              ...
              >
                ...
                <h3 className="font-[Montserrat] font-bold text-[#0D1F0D] text-lg mb-3">
                  {v.title}
                </h3>
      ...
      {/* ══ TIMELINE ══════════════════════════════════════════════════════ */}
      <section ref={timelineRef} className="py-24 bg-[#0D1F0D] relative overflow-hidden">
              ...
              {timeline.map((item, i) => (
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    <div className={`w-12 h-12 rounded-full ${item.dot} flex items-center
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex-1
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      <span className={`text-xs font-bold px-2.5 py-1 rounded-full
                                       ${item.dot.replace("bg-", "bg-")} text-white`}>
                        {item.year}
                      </span>
      ...
      {/* ══ TEAM ══════════════════════════════════════════════════════════ */}
      <section ref={teamRef} className="py-24 bg-[#F5F7F0]">
              ...
              >
                <div
                  className={`w-20 h-20 rounded-full bg-gradient-to-br ${t.color}
                              ...
                              text-2xl mx-auto mb-5 shadow-lg`}
                >
                  {t.init}
                </div>
                <h3 className="font-[Montserrat] font-bold text-[#0D1F0D] text-xl">
                  {t.name}
                </h3>
                <p className="text-[#1E9C17] font-semibold text-sm mt-1">{t.role}</p>
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <span
                key={t.label}
                className={`px-4 py-2 rounded-full text-sm font-semibold ${t.color}`}
              >
                {t.label}
              </span>
            ))}
      ...
      {/* ══ FAQ ═══════════════════════════════════════════════════════════ */}
      <section ref={faqRef} className="py-24 bg-[#F5F7F0]">
          ...
          <div className="space-y-3">
            {faqs.map((item, i) => (
              ...
              >
                ...
                >
                  <span className="font-semibold text-[#0D1F0D] text-sm leading-snug">
                    {item.q}
                  </span>
                  <span
      ...
      <section className="bg-[#1E9C17] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-20
          ...
          <div className="flex flex-wrap gap-4 flex-shrink-0">
            ...
            <Link
              to="/contact"
              className="border-2 border-white/50 text-white font-semibold px-8 py-4
