...
/* How it works — each step reveals on scroll via IntersectionObserver */
const steps = [
  {
    num: "01",
    title: "Register Once",
...
/* Single step card — animates in when scrolled into view */
      ...
      >
        {doubled.map((item, i) => (
          ...
          >
            ...
            <span className="ml-1 text-xs bg-green-50 text-green-700 font-semibold
      ...
      <div className="w-full font-[Poppins] text-[#1D1D1D] overflow-x-hidden">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-12 w-full">
            ...
            >
              ...
              <span
                ...
                style={{ WebkitTextStroke: "2px #1E9C17" }}
              >
                Table.
              </span>
              <br />
            ...
            <div
              ...
              style={{
                opacity:   heroLoaded ? 1 : 0,
                transform: heroLoaded ? "translateY(0)" : "translateY(20px)",
                transition: "all 0.7s ease 650ms",
              }}
            >
              <Link
                to="/register"
                className="group relative overflow-hidden bg-[#1E9C17] text-white
            ...
            >
              {[
                ...
                >
                  <p className="font-[Montserrat] font-black text-white text-xl leading-none">
                    {s.val}
                  </p>
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col
                          items-center gap-2 text-white/40 animate-bounce">
        ...
        <section ref={cheapRef} className="py-14 bg-[#F5F7F0] relative overflow-hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-24 z-10
                          bg-gradient-to-r from-[#F5F7F0] to-transparent pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-24 z-10
                          bg-gradient-to-l from-[#F5F7F0] to-transparent pointer-events-none" />

          <div
            className="max-w-7xl mx-auto px-6 lg:px-12 mb-6"
            style={{
              opacity:   cheapVisible ? 1 : 0,
              transform: cheapVisible ? "translateY(0)" : "translateY(20px)",
          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#1E9C17]">
                  Live Cheapest Prices
                </span>
              </div>
              <div className="h-px flex-1 bg-gradient-to-r from-[#1E9C17]/20 to-transparent" />
              <span className="text-xs text-gray-400 hidden sm:block">
                Direct from farmers · Updated daily
              </span>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div
                style={{
                  ...
                  transform: whyVisible ? "translateX(0)" : "translateX(-40px)",
              ...
              >
                ...
                <h2
                  className="font-[Montserrat] font-black text-white mt-4 leading-tight"
                ...
                <p className="mt-6 text-[#9CAD9C] text-base leading-relaxed max-w-md">
                  ...
                  rest. MeroBari eliminates every unnecessary step — so the person
                  who grows your food actually benefits.
                </p>
                ...
                <div className="mt-10 grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i} className="bg-white/5 rounded-2xl p-5 border border-white/10">
                      <p className="text-xs text-[#9CAD9C] uppercase tracking-widest mb-3">
                        {item.label}
                      </p>
                      <div className="flex items-end gap-3">
                        <span className="text-white/30 text-sm line-through">{item.before}</span>
                        <span className={`font-[Montserrat] font-black text-2xl ${item.color}`}>
                          {item.after}
                        </span>
                      </div>
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div
              ...
              style={{
                ...
                transform: catVisible ? "translateY(0)" : "translateY(24px)",
                transition: "all 0.7s ease",
              }}
            >
              <span className="text-[#1E9C17] text-xs font-semibold uppercase tracking-[0.25em]">
              ...
              {categories.map((cat, i) => (
                ...
                >
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="bg-[#1E9C17] text-white text-xs font-bold px-3 py-1 rounded-full">
                      {cat.price}
                    </span>
                  </div>
        ...
        {/* ══════════════════════════════════════════════════════
            HOW IT WORKS — scroll-reveal with dot + line per step
        ══════════════════════════════════════════════════════ */}
        <section className="py-28 bg-white relative overflow-hidden">
          {/* giant ghost text */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2
                          font-[Montserrat] font-black text-[18rem] leading-none
                          text-[#F0F0F0] select-none pointer-events-none">
            D2C
          </div>
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-3 text-gray-500 text-base max-w-md">
                    Three steps separate you from fresh, farmer-direct produce.
        ...
        <section ref={testimonialRef} className="py-28 bg-[#0D1F0D] relative overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 50%, #1E9C17 0%, transparent 50%)," +
                "radial-gradient(circle at 80% 20%, #FDB933 0%, transparent 40%)",
            }}
          />
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 relative">
            <div
              ...
              style={{
                ...
                transform: testimonialVisible ? "translateY(0)" : "translateY(24px)",
                transition: "all 0.7s ease",
              }}
            >
              <span className="text-[#1E9C17] text-xs font-semibold uppercase tracking-[0.25em]">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {testimonials.map((t, i) => (
                <div
                  ...
                  style={{
                    opacity:   testimonialVisible ? 1 : 0,
                    transform: testimonialVisible ? "translateY(0)" : "translateY(40px)",
        ...
        <section className="bg-[#1E9C17] relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-24
            ...
            <div className="flex flex-wrap gap-4 flex-shrink-0">
              <Link
                to="/register"
                className="bg-white text-[#1E9C17] font-bold px-8 py-4 rounded-full
              ...
              <Link
                to="/register"
                className="bg-[#FDB933] text-black font-bold px-8 py-4 rounded-full
                           text-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
              >
                Shop as Consumer
              </Link>
