  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 animate-fadeIn">
      ...
      <div className="relative bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl w-full sm:max-w-md overflow-hidden animate-slideUp">
        ...
        <div className="px-5 sm:px-6 py-4 bg-gray-50 flex flex-col-reverse sm:flex-row sm:justify-end gap-2 sm:gap-3">
          <button
            onClick={onClose}
            className="w-full sm:w-auto border border-gray-300 text-gray-700 font-semibold px-6 py-2.5 sm:py-2 rounded-lg hover:bg-gray-100 active:bg-gray-200 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 text-sm"
          >
            {cancelText}
          </button>
          <button
            onClick={handleConfirm}
            className={`w-full sm:w-auto ${styles.button} text-white font-semibold px-6 py-2.5 sm:py-2 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-offset-2 text-sm`}
          >
            {confirmText}
          </button>
        </div>
